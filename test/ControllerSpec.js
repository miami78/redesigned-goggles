...
describe('controller', function () {
	...
	describe('toggle all', function () {
		...
		it('should update the view', function () {
			// TODO: write test
			var todo = {id: 35, title: 'my todo', completed: true};
			setUpModel([todo]);

			subject.setView('');

			var value = {	completed: false};
			view.trigger('toggleAll', value);

			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 35, completed: false});
		});
	});
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			...
			var newAddition = "a new to do";
			view.trigger("newTodo", newAddition);
